/*
 ...
 Source Schema         : hl-tiny

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 20/09/2023 13:49:56
*/
...
CREATE TABLE `ums_menu`  (
  ...
  `show_link` tinyint(1) NULL DEFAULT NULL COMMENT '是否隐藏',
  ...
  `rank` int(4) NULL DEFAULT NULL COMMENT '菜单排序',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of ums_menu
-- ----------------------------
INSERT INTO `ums_menu` VALUES (21, NULL, 'system', 'layout', '/system', '系统管理', 'fa fa-cog', NULL, 1, 1, 0, 0, 1);
INSERT INTO `ums_menu` VALUES (22, 21, 'systemUser', '/system/user', '/system/user', '用户列表', 'ele-Avatar', NULL, 1, 1, 0, 0, 1);
INSERT INTO `ums_menu` VALUES (23, 21, 'systemRole', '/system/role', '/system/role', '角色列表', 'ele-Briefcase', NULL, 1, 1, 0, 0, 2);
INSERT INTO `ums_menu` VALUES (24, 21, 'systemMenu', '/system/menu', '/system/menu', '菜单列表', 'fa fa-list', NULL, 1, 1, 0, 0, 3);
